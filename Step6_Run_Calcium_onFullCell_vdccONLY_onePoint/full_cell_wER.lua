...
-- Added by Rosado
-- vdcc mode
vdccMode = util.GetParamNumber("-vdcc",1) 
...
compute_volume(approxSpace, "cyt, er, syn, pm, erm,")
...
while endTime-time > 0.001*dt do
	if vdccMode then
		print("vdcc Mode is set to TRUE")	
	end
